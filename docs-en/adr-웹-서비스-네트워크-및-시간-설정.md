...
<!-- Example: [ADR-0005](0005-example.md)The provided text "로" translates to "as" or "with" in English, depending on context. Without additional context, a direct translation cannot specify the exact usage intended. Please provide more context if needed for a precise translation. Improved -->
<!-- Options -->
