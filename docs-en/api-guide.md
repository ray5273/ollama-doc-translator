...
curl -X POST http://localhost:11434/api/generate \
  ...
  -d '{
    ...
    "prompt": "Next Please provide the Korean text you would like translated to English. Please provide the Korean text you would like translated. It seems there might be a misunderstanding as no Korean text was provided for translation in your request. Could you please provide the Korean text you would like translated into English? Please provide the Korean text you would like translated.: Hello",
    "stream": false
  }'
```
