...
curl -X POST http://localhost:11434/api/generate \
  ...
  -d '{
    ...
    "prompt": "Next Please provide the Korean text you would like translated. Please provide the Korean text you would like translated. Please provide the Korean text you would like translated. Please provide the Korean text you would like translated.: Hello",
    "stream": false
  }'
```
