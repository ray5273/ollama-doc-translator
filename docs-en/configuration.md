...
- uses: your-username/ollama-doc-translator@v1
  with:
    ...
    # PR Setup
    create-pr: true
    pr-title: 'Document Please provide the Korean text you would like translated. Update'
...
These settings can be combined to configure an optimal translation workflow for your project.
