...
This explains detailed setup options and customization methods for the Ollama document translator.
...
- uses: your-username/ollama-doc-translator@v1
  with:
    ...
    # Public Relations Setup
    create-pr: true
    pr-title: 'Document Translation Update'
    pr-branch: 'translate-docs'
    commit-message: 'docs: Please provide the Korean text you would like translated. Document 영어 Translation Addition'
...
│   ├── README.md
│   └── guide.md
└── docs-en/        # Please provide the Korean text you would like translated.
    ├── README.md
    └── guide.md
```
...
→ Translation
Please provide the Korean text you would like translated. After
...
```yaml
# Translation under specific conditions only
...
- name: Notify Slack
  ...
  with:
    status: success
    text: 'Document Translation is It is completed.: ${{ steps.translate.outputs.pr-url }}'
```
...
Please provide the Korean text you would like translated. Completed'
    body: 'New Translation PR It was created..'
```
...
```markdown
<!-- Please provide the Korean text you would like translated. From the chunk -->
```python
