...
- uses: your-username/ollama-doc-translator@v1
  with:
    ...
    commit-message: 'docs: Please provide the Korean text you would like translated to English. Document It seems there might be a misunderstanding in your request as no Korean text was provided for translation into English. Could you please provide the Korean text you would like translated? Translation Additional'
...
### Token Management
```yaml
# Use of Minimum Privilege Tokens
permissions:
  contents: read
  pull-requests: write
