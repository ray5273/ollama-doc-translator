...
This document provides a detailed guide on how to install and configure Ollama Document Translator.
...
Once Ollama is installed, download the model for translation:
...
3. **Simple Translation Test**:
   ```bash
   ollama run exaone3.5:7.8b "Hello, translate this greeting into English"
   ```
...
1. **GitHub Repository** → **Settings** → **Actions** → **Runners** → Move
