...
```bash
# Grant execution permission to the Ollama binary
...
Once installed, refer to the following documents:

- [Configuration Guide](configuration.md) - Detailed Configuration Options
- [API Guide](api-guide.md) - API Usage
- [Troubleshooting Guide](troubleshooting.md) - Common Problem Solutions
