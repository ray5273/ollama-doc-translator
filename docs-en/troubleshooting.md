...
This guide provides common issues encountered while translating Ollama documents and their respective solutions.
...
4. **Improve Prompt**:
   ...
   Ensure accurate Markdown formatting and retain technical terms in their original form.
...
4. **Preservation of Numbered Lists**:
...
2. **Utilize Section-Based Segmentation**:
...
A: Add instructions like "Keep technical terms in the original language" to your prompt.
